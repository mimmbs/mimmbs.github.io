class dbr {
    ...
    constructor(lang) {
        this.lang = lang;
        this.customers = [
            { id: 1694346647284, name: "Hasan AKSU", phone: "0532 607 3239", address: "Edirne", active: true },
            { id: 1693861667285, name: "E.K.F TURİZM İNŞ. MLZ. PAZ. VE İNŞ. TAAHÜT TİC.", phone: "", address: "Edirne", active: true },
            { id: 1693861667286, name: "Şaban KUTLU", phone: "", address: "Edirne", active: true },
            { id: 1693861667287, name: "FEN ELEKTRİK LTD. ŞTİ.", phone: "", address: "Edirne", active: true },
            { id: 1693861667288, name: "Emrah ÖZDEMİR", phone: "0544 539 0914", address: "Edirne", active: true },
        ];
        this.transactions = {
            1694346647284: [
    ...
    static async Server() {
        ...
        return { calendar: { date: new Date().toLocaleDateString(), time: new Date().toLocaleTimeString().slice(0, 5) }, currency: { eur: 28.79, usd: 26.85 } };
    }
    ...
    async SaveCustomers(edited) {
        await new Promise(resolve => (setTimeout(resolve, 400)));
        this.customers = edited;
        this.LogTransaction('E', null, null, edited, null);
    }
    ...
    async UpdateOrInsert(customer, editedIndex, editedItem) {
        ...
        this.LogTransaction((editedIndex > -1 ? 'U' : 'C'), customer, editedIndex, editedItem, null);
        await new Promise(resolve => (setTimeout(resolve, 400)));
    }

    async Delete(customer, editedIndex, editedItem) {
        this.LogTransaction('D', customer, editedIndex, editedItem, null);
        await new Promise(resolve => (setTimeout(resolve, 400)));
    ...
    async LogTransaction(crud, customer, editedIndex, editedItem, user) {
        ...
        console.log(crud, `${now[0]} ${now[1].substring(0, 5)}`, customer, editedIndex, editedItem, user);
    }
}
